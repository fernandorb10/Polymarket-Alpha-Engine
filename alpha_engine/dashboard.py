...
def home():
    ...
    <body><main>
      <div class='topbar'><div><h1>EL ROJILLA BOT</h1><div class='muted'>Paper trading · Gemini · Refresh every {settings.dashboard_refresh_seconds} seconds</div></div>
